...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div id="login-failure" style="display: none" class="alert alert-danger">
            <strong>Error!</strong> Invalid Login
        </div>

        <!-- Login Form -->
        <form id="login-form" class="vlad" method="POST" action="login">
            <span>${message!''}</span>
            ...
            <#if error??>
                <div class="alert alert-danger fadeIn fourth">
                    <strong>Error!</strong> ${error}
                </div>
            </#if>

            <button type="submit" class="btn btn-primary fadeIn fourth">Login</button>

            <h4 class="text-center fadeIn fourth"><a href="<@spring.url "/register"/>">Create an account</a></h4>
        </form>
...
<#--    Password:<br>-->
<#--    <input-->
<#--    <@spring.formInput "userLogIn.password"/>-->
